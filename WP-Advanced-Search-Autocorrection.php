...
function WP_Advanced_Search_Callback_Autocorrection() {
	...
	if(isset($_POST['wp_advanced_search_action_addwords'])) {
		WP_Advanced_Search_Autocorrection_AddWords();
	}
       	...
       	<div class="block">
            ...
            <div class="col">
				...
				<?php
                    ...
                    $sqlShow = $wpdb->query("SHOW TABLES FROM ".$select->db." LIKE '".$wpdb->prefix."autocorrectindex'");
                    if($sqlShow != 1) {
                ?>
                <p class="tr">
                ...
                <p class="tr2">
                    ...
                    <select name="wp_advanced_search_autocorrection_deletewords[]" multiple="multiple" id="deleteSelect" size="12">
					<?php
...
function WP_Advanced_Search_Autocorrection_AddWords() {
	global $wpdb, $table_WP_Advanced_Search; // insérer les variables globales
	...
	$expressions = array_map('trim', explode(',',htmlspecialchars($_POST['wp_advanced_search_autocorrection_addwords'])));
