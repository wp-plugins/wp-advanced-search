       	...
       	<div class="block">
            ...
            <div class="col">
				...
				<?php
                    ...
                    $sqlShow = $wpdb->query("SHOW TABLES FROM ".$select->db." LIKE '".$select->autoCompleteTable."'");
                    if($sqlShow != 1) {
                ?>
                <p class="tr">
...
function WP_Advanced_Search_Autocompletion_AddWords() {
	global $wpdb, $table_WP_Advanced_Search; // insérer les variables globales
	...
	$expressions = array_map('trim', explode(',',htmlspecialchars($_POST['wp_advanced_search_autocompletion_addwords'])));
