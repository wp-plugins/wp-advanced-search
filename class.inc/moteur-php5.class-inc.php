...
class moteurRecherche {
	...
	private $limitArg;			// Numéro de départ de la clause LIMIT (0 par défaut)
	private $limit;				// Nombre de résultats par page (si pagination sur "true")
	...
	public $nbResultsChiffre;	// Nombre de résultats retournés mais en chiffre cette fois (pour la pagination)
	...
	/*---------------------------------------------------------------------------------*/
	public function moteurAffichage($callback = '', $colonnesSelect = '', $limit = array(false, 0, 10), $ordre = array(true, "post_date", "DESC"), $algo = array(false,'algo','DESC','id'), $orderLimitPerso = 'AND post_status = \'publish\'') {
...
class surlignageMot {
	...
	/*-------------------------------------------------------------------*/
	public function __construct($mots, &$contenu, $typeSurlignage = "exact") {
		foreach($mots as $mot) {			
