...
//		$champ = mb_convert_case(strip_tags($champ), MB_CASE_LOWER, $mb_encode);
	...
	/*---------------------------------------------------------------------------------*/
	function moteurAffichage($callback = '', $colonnesSelect = '', $limit = array(false, 0, 10), $ordre = array(true, "post_date", "DESC"), $algo = array(false,'algo','DESC','id'), $orderLimitPerso = '', $conditionsPlus = '') {
